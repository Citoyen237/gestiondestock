...
<?php
  ...
  if(isset($_POST['supprimer'])){
    ...
    $sql22="DELETE FROM `achats` WHERE `codeFac`='$idz'";
      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <button>
                    <?php
                       $quer="SELECT * FROM `factures` WHERE `type`='achat'";
              ...
              <tbody>
                <?php
                       ...
                       //determination du nombre d'utilisateur total
                         $sqq="SELECT * FROM `factures` WHERE `type`='achat' ORDER BY `date_fac` DESC ";
                       $re=$con->query($sqq);
                       ...
                       $premier=($currentPage*$parPage)-$parPage;
                         $sql="SELECT * FROM `factures`WHERE `type`='achat' ORDER BY `date_fac` DESC limit $premier,$parPage";
                       $re=$con->query($sql);
                       ...
                       while($row=mysqli_fetch_assoc($re)){
                        ...
                        <td>$montantf</td>
                        <td>
                        <form method='post' action='BilanAchat.php'>
                        ...
                        <input type='hidden' value='$numfac' name='idf'> </form>
                        </td></tr>
              ...
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  new ApexCharts(document.querySelector("#lineChart"), {
                    series: [{
                      name: "Desktops",
                      data: [10, 70, 35, 51, 49, 12, 69, 71, 50]
                    }],
                    chart: {
                      height: 350,
                      type: 'line',
