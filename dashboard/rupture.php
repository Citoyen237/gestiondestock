    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Liste|rupture</li>
        </ol>
      </nav>
    </div>
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Produits en rupture de stock
                <a href="NewAchat.php" class="btn btn-primary">Commander</a>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  $sqq = "SELECT * FROM `produits` WHERE `quandite` <5  ";
                  $re = $con->query($sqq);
                  ...
                  $sql = "SELECT * FROM `produits` WHERE `quandite` <5 limit $premier,$parPage";
                  $re = $con->query($sql);
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="Clients.php">
            ...
            <div class="mb-3">
              <a href="lister.php" class="btn btn-warning form-control">Imprimer</a>
            </div>
        </div>
        <div class="modal-footer">
          <a href="lister.php" class="btn btn-warning">Tous</a>
        </div>
      </div>
    </div>
  </div>
