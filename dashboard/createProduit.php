...
<?php
  ...
  if(isset($_POST['valider'])){
    ...
    $date =date("Y-m-d");
      $sql1="INSERT INTO `produits`(`id_pro`, `nom`, `prix_vente`, `prix_achat`, `description`, `quandite`, `categorie_id`, `date_e`) 
      VALUES (NULL,'$$nom','$prixA','$prixB','$description','$quandite','$categorie','$date')";
      $query1=$con->query($sql1) or die('error');
      if($query1==true){
        $message='<div class="alert alert-success alert-dismissible fade show" role="alert">
        <i class="bi bi-check-circle me-1"></i>
        produit ajouter avec success!<a href="produits.php" class="btn btn-link">Retour</a>
  ...
  <main id="main" class="main">
          <div class="card">
            <div class="card-body">
              ...
              <?=$message?>
              <!-- Multi Columns Form -->
              <form class="row g-3" method="post" action="createProduit.php" autocomplete="off">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" class="form-control" id="inputEmail5" name="prixA"  required>
                </div>
                <div class="col-md-6">
                  <label for="inputPassword5" class="form-label">Prix de vente:</label>
                  <input type="number" class="form-control" id="inputPassword5" name="prixV">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  <label for="inputAddress2" class="form-label">Quantite:</label>
                  <input type="number" class="form-control" id="inputAddress2" placeholder="" name="quandite"  required>
                </div>
                <div class="col-md-12">
