          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-3">
              <div class="card info-card revenue-card">
                <div class="card-body">
                  <h5 class="card-title">Nombre d'achat</h5>
            ...
            <div class="col-xxl-4 col-md-3">
              ...
              <div class="card info-card customers-card">
                <div class="card-body">
                  <h5 class="card-title">Appareils travailler</h5>
              ...
              <div class="card info-card customers-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <i class="bi bi-clipboard-minus text-secondary"></i>
                    </div>
                    <div class="ps-3">
                      <h6>124</h6>
                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Clients/fournisseurs</th>
                        <th scope="col">Designation/Taff</th>
                        <th scope="col">Prix</th>
                        <th scope="col">Type op</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>$47</td>
                        <td><span class="badge bg-warning">Vente</span></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>$67</td>
                        <td><span class="badge bg-danger">Depenses</span></td>
                      </tr>
                    </tbody>
                  </table>
